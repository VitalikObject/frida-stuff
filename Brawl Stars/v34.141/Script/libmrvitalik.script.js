...
var SERVER_CONNECTION = 0xD2E718; // search 'push notification registration' string x-refs to 'NotificationManager::update' function
var NEW_OPERATOR = 0x8953BC + 1; // get through dropGuiTextField func
var WAKEUP_RETURN_ARRAY = [0xCAAB4, 0xE00C0, 0x14345C, 0x36FF6C, 0x452320, 0x54BFFC];
